...
| Page templates | 6 | PatientQueryTemplate, PatientRecordTemplate, Patient360Template, BillingClinicWorkspace, ClinicalTriageWorkspace, ClinicalConsultationWorkspace | API data/metadata, fields/actions, locks, formatting, shortcuts, previews, errors and relevant scope |
...
Total: 137 unique destinations. The [inventory](inventory.json) names each page and engine; the [original audit inventory](../../../desktop-clients/docs/library-preference-audit.md) preserves the pre-correction findings.
