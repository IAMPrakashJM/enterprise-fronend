...
The Library inventory contains 158 destinations. Runtime documentation covers 315 page registrations: 147 authored workflow guides and 168 inherited reference-only guides. The [generated backlog](documentation/backlog.json) records 1,113 authoring/translation-review items. These comprise 168 authoring issues, 516 incomplete translation entries and 429 current translations awaiting native review. They are individual issues, not 1,113 missing pages. Four authored guides still have untranslated field/tour metadata: Customer Master, Patient Master, Preferences and Documentation Center. Native/domain review, physical-device integration and production-service acceptance remain explicitly pending where documented. Automated validation does not certify those reviews.
