...
const source=readFileSync(new URL('template-demo.tsx',directory),'utf8').replace("from './page-template'","from '@pepbits/erp-screens'").replace("from './template-state'","from '@pepbits/erp-screens'").replace("from '../preference-choice'","from '@pepbits/erp-screens'");
