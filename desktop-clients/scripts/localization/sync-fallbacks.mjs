...
const fallbackKeys=Object.keys(catalogs.en).filter(key=>key.startsWith('ui.')||key.startsWith('preference.')||key.startsWith('recovery.')||key.startsWith('recovery.')||key.startsWith('recovery.')||key.startsWith('recovery.')||key.startsWith('sentinel.')||key.startsWith('api.')||key===catalogs.en[key]);
